...
export const createBooking = async (req, res) => {
    const { user_id, transport_id, hotel_id, booking_date } = req.body;
    
    try {
        const result = await pool.query(
            'SELECT fn_create_booking($1, $2, $3,$4) as booking_id',
            [user_id, transport_id, hotel_id,booking_date || null]
        );
        ...
        res.json({
            ...
            city_id: costResult.rows[0].city_id,
