...
//           className={`text-2xl ${s <= value ? 'text-yellow-400' : 'text-gray-300'} ${!readOnly && 'hover:scale-110'} transition-transform`}
//         >
//           ★
//         </button>
//       ))}
...
//               {userReview.comments && (
//                 <p className="text-sm text-gray-700 mt-2">{userReview.comments}</p>
//               )}
...
//             {reviews.map(rev => (
//               <div key={rev.review_id} className="bg-gray-50 p-3 rounded-lg">
//                 <div className="flex justify-between items-start mb-1">
//                   <span className="font-medium text-sm">{rev.user_name || 'Anonymous'}</span>
//                   <span className="text-yellow-500 text-sm">★ {rev.rating}</span>
//                 </div>
//                 {rev.comments && (
//                   <p className="text-sm text-gray-700">{rev.comments}</p>
//                 )}
